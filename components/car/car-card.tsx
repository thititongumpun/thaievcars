  ...
  return (
    <Link href={`/cars/${car.slug}`} className="group block">
      ...
      <div className="relative aspect-[16/9] bg-muted">
        <Image src={coverImage} alt={localize(car.name, locale)} fill loading={eagerImage ? "eager" : "lazy"} className="object-cover transition duration-300 group-hover:scale-105" sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" />
      </div>
